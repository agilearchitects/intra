...
export interface ITinyMCEState { } // tslint:disable-line:no-empty-interface

export const tinyMCEStore: Module<ITinyMCEState, IAppState> = {
  namespaced: true,
  getters: {
    init: (state: ITinyMCEState, getters: any, rootState: IAppState, rootGetters: any) => (buttons: string = "", setup?: (editor: any) => void): ITinyMCESettings => {
      return {
  ...
  } as GetterTree<ITinyMCEState, IAppState>,
};
